...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-zinc-900 via-zinc-950 to-black selection:bg-rose-500/30 overflow-x-hidden relative font-sans">
      ...
      <div className="max-w-lg w-full z-10 flex flex-col">
        ...
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-600 to-orange-600 rounded-[2rem] md:rounded-[2.5rem] blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
          ...
          <main className="relative bg-zinc-900/40 border border-white/10 p-6 md:p-12 rounded-[1.8rem] md:rounded-[2.4rem] shadow-2xl backdrop-blur-xl">
                ...
                <div className="space-y-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-zinc-950/50 border border-white/5 rounded-xl md:rounded-2xl pl-10 md:pl-12 pr-6 py-4 md:py-5 text-lg md:text-xl focus:outline-none focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500/50 transition-all placeholder:text-zinc-700 font-medium"
                    />
                  </div>
                  {error && (
                    <p className="text-rose-500 text-[10px] md:text-sm font-bold pl-2 animate-pulse">
                      {error}
                    </p>
                  )}
                </div>
            ...
            {loading && (
              <div className="py-12 md:py-16 flex flex-col items-center space-y-6 md:space-y-8 animate-in fade-in duration-300">
                <div className="relative">
                ...
                <div className="text-center space-y-2">
                  ...
                  <div className="flex gap-1 justify-center">
                    <div className="w-1.5 h-1.5 bg-rose-600 rounded-full animate-bounce [animation-delay:-0.3s]"></div>
                    <div className="w-1.5 h-1.5 bg-rose-600 rounded-full animate-bounce [animation-delay:-0.15s]"></div>
                    <div className="w-1.5 h-1.5 bg-rose-600 rounded-full animate-bounce"></div>
                  </div>
                </div>
              </div>
            )}
            ...
            {result && !loading && (
              <div className="space-y-6 md:space-y-8 animate-in slide-in-from-bottom-8 fade-in duration-700">
                ...
                <div className="relative group/roast">
                  <div className="absolute inset-0 bg-rose-600/5 rounded-xl md:rounded-2xl blur-sm group-hover/roast:bg-rose-600/10 transition-all"></div>
                ...
                <div className="flex flex-col items-center gap-3">
                  <button
                    onClick={handleShare}
                    className="flex items-center justify-center gap-2 w-fit px-6 bg-[#1DA1F2] hover:bg-[#1a91da] text-white font-bold py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm transition-all transform hover:scale-[1.01] active:scale-[0.98] opacity-80 hover:opacity-100"
                  >
